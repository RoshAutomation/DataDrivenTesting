...
public class TestConfig{
	...
	public static String from = "roshankgupta93@gmail.com";
	public static String password = "8013896249";
	public static String[] to ={"roshankgupta93@gmail.com","vbandale09@gmail.com"};
